...
data.frame(cc_smooth[1013:1025, c(1, 5)])
```
...
# sample_sentiments
data.frame(sentiments[sentiments$lexicon=="AFINN", ][1:13, c(1, 3, 4)])
```

Major points 
================================================================================

## Data science needs *better teaching examples*, especially if we want to reach undergraduate and high school students. These examples need to be *easy to run* and *easy to relate to*.
...
data.frame(cc_smooth[1013:1025, c(1, 5, 2)])
```
